...
formats (RGB, HSL colorspace, built-in palettes) and can adapt palettes to
color vision deficiencies (CVD) of the full dichromacy spectrum (protanopia,
deuteranopia, tritanopia) and varying severity. The
