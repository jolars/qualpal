<script lang="ts">
  ...
  export let onChange: (values: { lightMin: number; lightMax: number }) => void = () => {};
...
<div class="flex justify-center">
  <svg width={width} height={height + 20} style="touch-action:none;">
    <defs>
    ...
    <rect x={padding} y="10" width={width - 2 * padding} height={height} fill="url(#lightness-gradient)" rx="4"/>
