...
function(lcov_merge_files OUTFILE ...)
    ...
    add_custom_command(
        ...
        COMMAND
            ${LCOV_BIN} --quiet -r ${OUTFILE} ${LCOV_REMOVE_PATTERNS}
...
function(lcov_capture_tgt TNAME)
    ...
    foreach(FILE ${SOURCES})
        ...
        add_custom_command(
            OUTPUT ${OUTFILE}
            COMMAND
                test -s "${TDIR}/${FILE}.gcda" && ${GCOV_ENV} ${GENINFO_BIN}
                --quiet --base-directory ${PROJECT_SOURCE_DIR} --gcov-tool
                ${GCOV_BIN} --output-filename ${OUTFILE} ${GENINFO_EXTERN_FLAG}
                ${TDIR}/${FILE}.gcda || cp ${OUTFILE}.init ${OUTFILE}
    ...
    add_custom_target(
        ...
        COMMAND
            ...
            ${PROJECT_SOURCE_DIR} --baseline-file
            ${LCOV_DATA_PATH_INIT}/${TNAME}.info --output-directory
...
function(lcov_capture)
    ...
    if(NOT TARGET lcov)
        ...
        add_custom_target(
            lcov
            COMMAND
                ${GENHTML_BIN} --quiet --sort ${GENHTML_CPPFILT_FLAG}
                --baseline-file ${LCOV_DATA_PATH_INIT}/all_targets.info
                --output-directory ${LCOV_HTML_PATH}/all_targets --title
                "${CMAKE_PROJECT_NAME}" --prefix "${PROJECT_SOURCE_DIR}"
                ${OUTFILE}
