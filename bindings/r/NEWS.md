...
- The backend of the package has been entirely rewritten in C++
  and development has been moved to <https://github.com/jolars/qualpal>
- When catering to color blindness, `qualpal()` now returns the original colors and not,
  which was really never intentional, colors in the color space modified for
  color deficiency.
